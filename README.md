...
Hi! This is a website built using HTML, CSS and JS, and also NodeJS to serve files and protect pages. You can switch to the folder of your choice and run this on your machine running the following commands:
